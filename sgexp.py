...
class sg(MovingCameraScene):
    def construct(self):
        ...
        self.add(dash_line)
        blue_dot1 = Dot(radius = 0.05 , color = PURE_BLUE)
        ...
        #dots 
        red_dot1 = Dot(radius = 0.05 , color = PURE_RED)
        ...
        yellow_dot1 = Dot(radius = 0.05 , color = YELLOW)
        ...
        red_dot3 = Dot(radius = 0.05 , color = PURE_RED)
        ...
        red_dot2 = Dot(radius = 0.05 , color = PURE_RED)
        ...
        yellow_dot2 = Dot(radius = 0.05 , color = YELLOW)
        ...
        eigen_eq.to_edge(LEFT)
        self.play(Write(eigen_eq), run_time = 2, rate_func = linear)
        self.wait(2)
        eigen_math = MathTex(r" A  \ | \grave{a} > =  \grave{a}  \ | \grave{a} >").scale(2)
        ...
        arrow1 = Arrow(frame_box1.get_bottom(), frame_box4.get_left())
